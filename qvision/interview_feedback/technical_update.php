...
$sql2= $con->query("Update technical_team_details set head_status='$status_recruiters',rating='$ratings',remarks='$remarks' where candidate_id='$candidate_id'");
...
echo "Update candidate_round_details set status='$status_recruiters' where candid_id='$candidate_id'  and person_id='$user_id'";
