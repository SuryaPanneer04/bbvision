...
$sql1 = $con->query("INSERT INTO `domain_entries_hod`(`candids_id`, `hire_id`, `round_id`, `round_name_id`, `feedback`) VALUES ('$candid_id','$user_id','$interviewroundids','$intername_ids','$section_names')"); 

echo "INSERT INTO `domain_entries`(`candid_id`, `hire_id`, `round_id`, `round_name_id`, `feedback`) VALUES ('$candid_id','$user_id','$interviewroundids','$intername_ids','$section_names'";
}
...
if($interviewround==$no_of_row){
    ...
    echo "Update candidate_form_details set status=41 where id='$candid_id'";
