...
$userid=$_SESSION['userid'];
 $query=$con->query("update md_commands set ctc='$ctc', md_commands='$remarks_md', md_status='$md_recruiter', status='$status', modified_by='$userid', modified_on='$date' where candidate_id='$candidateid'");
