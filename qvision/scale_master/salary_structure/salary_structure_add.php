...
<a onclick="scale_master_back()" style="float: right;" data-toggle="modal" class="btn btn-danger"></i>Back</a>
</div>
<div class="card-body">
<form method="POST">
...
<div class="col-sm-12">
<input type="button" class="btn btn-primary btn-md" style="float: right;" onclick="salary_create()" value="SAVE">
</div>
</div>
</form>
</div>
