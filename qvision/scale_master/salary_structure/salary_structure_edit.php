...
?>
	...
	<a onclick="scale_master_back()" style="float: right;" data-toggle="modal" class="btn btn-danger">Back</a>
	</div>
	<div class="card-body">
	<form method="POST">
	...
	<input type="button" class="btn btn-primary btn-md" style="float: right;" id="<?php echo $ids; ?>" onclick="scale_update(this.id)" value="Update">
	</div>
	</div>
	</form>
	</div>
...
function scale_update(v)
{
	...
	type:'GET',
	data: data + "&id=" + v,
	url:'qvision/scale_master/salary_structure/salary_structure_update.php?id='+v,
	success:function(data)
	{
		 if(data==1)
		{
