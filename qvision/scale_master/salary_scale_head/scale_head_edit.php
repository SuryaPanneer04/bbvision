...
?>
	...
	<a onclick="scale_head_tab_back()" style="float: right;" data-toggle="modal" class="btn btn-danger"></i>Back</a>
	</div>
	<div class="card-body">
	<form method="POST">
	...
	<td>
	<input type="checkbox" class="chk" name="chk[]" id="chk_<?php echo $s_d_id;?>" value="<?php echo $s_d_id;?>" style="width:15px;height:20px;" disabled>
	</td>
	<td>
	<select class="form-control" name="earnings[]" id="earnings_<?php echo $s_d_id;?>" onchange="earnings_validate(<?php echo $s_d_id;?>)" required="TRUE" readonly>
	...
	<td style="width:25%">
	<input type="button" class="btn btn-primary btn-md" style="float: right;" id="<?php echo $ids; ?>" onclick="scale_head_update(this.id)" value="Update">
	</td>
	</tr>
	</table>
