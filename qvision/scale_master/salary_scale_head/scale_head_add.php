...
<a onclick="scale_head_back()" style="float: right;" data-toggle="modal" class="btn btn-danger"></i>Back</a>
</div>
<div class="card-body">
<form method="GET">
...
<td>
<input type="text" class="form-control" name="percentage[]" id="percentage_1" >
</td>
</tr>			
</tbody>
</table>
...
<td style="width:25%"><input type="button" class="btn btn-success" name="scale_save" style="float: right;" onclick="scale_data_save()" value="SAVE"></td>
</tr>
</table>
</div>
</form>
...
function scale_data_save()
{
	...
	url:'qvision/scale_master/salary_scale_head/scale_head_insert.php',
		success:function(data)
		{
			console.warn("kokok:"+data);
			if(data !='' )
			{
