...
<input type="button" style="float:right;" class="btn btn-warning" name="new" value="ADD" onclick="leave_balance_add()">
</div>
<div class="card-body">
...
{
	// api url
	const api_url = "<?php echo Public_URL; ?>"+"/Leave_Management/api/leave_balance.php";
...
<script>
function leave_balance_add()
	{
		$.ajax({
		type:"POST",
		url:"Leave_Management/leave_balance/leave_balance_add.php",
