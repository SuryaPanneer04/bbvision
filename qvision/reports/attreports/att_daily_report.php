        ...
        <table id="summarySplitTable" class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th>Out Time</th>
                    <?php
                    if($attendance_type=='early_coming')
                    {
                    ?>
                    <th>Early Coming</th>
                    <?php
                    }
                    else if($attendance_type=='late_coming')
                    {
                    ?>
                    <th>Late Coming</th>
                    <?php
                    }
                    else if($attendance_type=='early_going')
                    {
                    ?>
                    <th>Early Going</th>
                    <?php
                    }
                    else if($attendance_type=='late_going')
                    {
                    ?>
                    <th>Late Going</th>
                    <?php
...
if ($attendance_type == 'early_coming') {
    ...
    <?php
} elseif ($attendance_type == 'late_coming') {
    ?>
    <td><?php echo ($lateComing !== "-" ? $lateComing . ' (HH:MM)' : '-'); ?></td>
    <?php
} elseif ($attendance_type == 'early_going') {
    ?>
    <td><?php echo ($earlyGoing !== "-" ? $earlyGoing . ' (HH:MM)' : '-'); ?></td>
    <?php
} elseif ($attendance_type == 'late_going') {
    ?>
