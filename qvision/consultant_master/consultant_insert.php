...
$user_group_code='R020';//CONSULTANT
  ...
  echo "INSERT INTO `consultant_master`(`consultant_name`, `con_org`, `phn_no`, `alt_phno`, `email`, `alt_email`, `percentage`, `status`) VALUES('$C_name','$org_name','$phone','$whatsapp','$mail','$alt_mail','$Percentage','$cer_status')";  
...
echo "insert into z_user_master(consultant_id,user_name,password,full_name,status,email_id,user_group_code,mobile_no,created_by,created_on)values('$consultant_id','$phone','$password','$fullname','1','$mail','$user_group_code','$phone','$user',now())";
...
<?php 
	...
	$mail->Username = 'bluebase.hr@gmail.com';					//Sets SMTP username
    $mail->Password = 'quadsel@2020#';					//Sets SMTP password
	
	$mail->SMTPSecure = 'ssl';							//Sets connection prefix. Options are "", "ssl" or "tls"
	$mail->From = 'rajeshwari@bluebase.in';			//Sets the From email address for the message
	 $mail->FromName = 'Quadsel';			//Sets the From name of the message
	// $mail->AddAddress($SENDMAIL, $FULLNAME);		//Adds a "To" address
	 $mail->AddAddress('rabijerome16@gmail.com');		//Adds a "To" address
