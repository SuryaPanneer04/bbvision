...
<i class="fa fa-table"></i>  Add Deduction
<a onclick="deduction_back()" style="float: right;" data-toggle="modal" class="btn btn-danger"></i>Back</a>
</div>
<div class="card-body">
...
<thead>
<tr><th>#</th><th>Employee Name</th><th>TDS</th><th>SAD</th></tr>
</thead>
<tbody>	
<tr class="row_1">	
<td>
...
<td>
<input type="text" class="form-control" name="tds[]" id="tax_deduct_source"  required>
</td>

<td>
<input type="text" class="form-control" name="sad[]" id="salary_advance_deduction" required>
</td>
