...
<div  class="card card-primary">
 ...
 <div class="card-header">
  <h3 class="card-title"><font size="5"> Prefixcode Master </font></h3>
	 <a onclick=" add_prefix()" style="float: right;" data-toggle="modal" class="btn btn-danger"><i class="fa fa-plus"></i> ADD</a>
</div>
...
<script>
  ...
  $.ajax({
    type:"POST",
    url:"qvision/masters/Prefixcode_master/new_code.php",
   ...
   function prefix_edit(v)
    ...
    $.ajax({
    type:"POST",
    url:"qvision/masters/Prefixcode_master/edit_code.php?id="+v,
    success:function(data){
    $("#main_content").html(data);
    }
    })
