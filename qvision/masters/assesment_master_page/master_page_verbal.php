...
<div  class="card card-primary">
	...
	<div class="col-lg-12">
	<h4 style="font-style:italic;">VERBAL QUESTIONS  </h4>
...
<?php
    ...
    $ttt = $_REQUEST['name'];
      ...
      $asses_sql=$con->query("SELECT * FROM asses_question where question_type = 5 ");
      $i=1;
      ...
      <input type="hidden" id="namee" name="namee" value="<?php echo $ttt; ?>"></input>
      
        <td colspan="6"><input type="checkbox" class="checkbox"  id="question"   name="question[]"  value="<?php echo $asses_res['question_no']; ?>" style="float:right;"></td>
...

{
   ...
   $.ajax({
    type:"POST",
	data: data + "&" + "id="+id,
    url:"qvision/masters/assesment_master_page/submit_verbal.php",
