...
<?php
      ...
      $asses_sql=$con->query("SELECT * FROM asses_question where question_type = 3 ");
      $i=1;
    ...
    <tr>
    <td>
     <colspan="6"><input type="button"  class="btn btn-dark" value="Submit"  style="float:right;color:white !important;" name="submit" onclick="reasoning_master()" value="submit">
</tr>
  </tbody>
</tbody>
  </table>
...

{
   ...
   $.ajax({
    type:"POST",
	data: data + "&" + "id="+id,
    url:"qvision/masters/assesment_master_page/submit_reasoning.php",
