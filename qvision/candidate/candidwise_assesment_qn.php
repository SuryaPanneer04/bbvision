...
<div class="card card-primary">
	...
	<?php 
	$qsel=$con->query("select * from candidate_form_details where id='$empid' and status='30'");
	//echo "select * from candidate_form_details where id='$empid' and status='30'";
$qsel->execute();
$counts = $qsel->rowCount();
if($counts==0 )
{
...
$select=$con->query("SELECT * FROM candidate_round_details where candid_id='$empid' and status =4 and person_id is null");
...
<input type="hidden" name="section_val_<?php echo $cnt;?>" id="section_val_<?php echo $cnt;?>" value="<?php echo $secid;?>">
<input type="hidden" name="qn_count" id="qn_count" value="<?php echo $qcounts;?>">
