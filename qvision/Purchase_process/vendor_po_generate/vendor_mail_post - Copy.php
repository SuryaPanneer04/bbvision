...
echo$sendermail = "antoajith2103@gmail.com";



//echo $person1=$myArray[0];
//echo $person2=$myArray[1];
//exit; */
...
<?php 
 ...
 <table width="710px" style="text-align:left; border: none;">
	<tr><td colspan="5"><img src="../../../images/04.png" alt="SS-Information" style="width:240px; height:70px;"><br/></br>
...
<TABLE width="710px" style="border: 1px solid black;">
 <tr style="border:1px solid black;"> 
	...
	<tr style="border :1px  solid  black;font-size:13px;"> 
		...
		<b>GST NO :</b> 33AAACQ0129P1ZG <br/><br/>
		<b>Company Phone No :</b> 044 23623544 
		</td>
	</tr> <br/> <br/>
 ...
 //terms and condition query
	 ...
	 <div class="container2"><br/>
		 <div style="text-align:left;">
		   <img src="../../../images/04.png" alt="SS-Information" style="width:240px; height:70px;">
		 </div><br/>
...
$mail->From = 'test1@ssinformation.in';		//Sets the From email address for the message
	...
	$mail->AddAddress($mailerID, $client_name);		//Adds a "To" address
	//$mail->AddAddress('antoajith.d@bluebase.in', $client_name);		//Adds a "To" address
	//$mail->AddAddress('rabijerome16@gmail.com');	
	$mail->AddCC($cc_mail);
	echo"vkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk";
