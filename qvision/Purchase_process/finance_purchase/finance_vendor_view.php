...
$stmt = $con->prepare("SELECT a.id,a.warrenty,a.price,a.cost_sheet_id,a.purchase_type,a.specification,a.upload,a.so_number,a.vendor_id, a.status,b.id as cost_id,b.cost_sheet_no as cost_no,b.qty,c.quote_no FROM purchase_vendor_master a left join cost_sheet_entry b on(a.cost_sheet_id=b.id) left join quote_generate c on b.cost_sheet_no = c.cost_sheet_no  where a.status=1 and a.id='$purchase_id'" );  //a.status=2

// echo "SELECT a.id,a.warrenty,a.price,a.cost_sheet_id,a.purchase_type,a.specification,a.upload,a.so_number,a.vendor_id,
// a.status,b.id as cost_id,b.cost_sheet_no as cost_no,b.qty FROM purchase_vendor_master a left join cost_sheet_entry b on(a.cost_sheet_id=b.id) where a.status=1 and a.id='$purchase_id'" ;
...
<div class="card card-info">
	 ...
	 <h2 class="card-title"><font size="4"><b>Vendor PO Approve</b></font> </h2></div>
...
<td colspan="4"><input type="text" class="form-control" id="cost_sheet_no" value="<?php echo $row['cost_no'];?>" name="cost_sheet_no" readonly></td>
</tr>
<tr>
<td><b>Quote No</b></td>
...
if (!$row1) {
    $row1 = [
	  ...
	  <div style="text-align:center;"> 
		    <input type="button" class="btn btn-success" id="save" name="save" onclick="approve_vendor()"  style="margin: 5px;" value="Approve">
   ...
   <!--<button class="open-button" onclick="openForm()">Open Form</button>-->
		...
		<div class="form-popup" id="myForm">
		  <form action="" class="form-container">
			...
			<button type="button" class="btn" onclick="revise_vendor()">Submit</button>
...
function approve_vendor()
{
	...
	type:'GET',
	data:"id="+id,
	url:"qvision/Purchase_process/finance_purchase/finance_vendor_approve.php?id="+id,
...
function revise_vendor()
{
	...
	url:"qvision/Purchase_process/finance_purchase/finance_vendor_reject.php?id="+id+'&remark='+remark,
	success:function(data)
	{      
