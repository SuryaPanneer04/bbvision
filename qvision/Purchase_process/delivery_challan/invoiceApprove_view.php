...
<div class="card card-info">
	 ...
	 <h2 class="card-title"><font size="4"><b>Invoice Approve</b></font> </h2>
     <a onclick="invoice_approve()" style="float: right;" data-toggle="modal" class="btn btn-danger"></i>Back</a>
    </div>
...
<tr>
				...
				<td colspan="4">
					<input type="text" class="form-control" id="clientName" value="<?php echo $row['org_name']; ?>" name="clientName" readonly>
				</td>
			</tr>
...
<?php
		$cost = $con->query("select * from cost_sheet_entry where id='$cost_id'");
		?>
   ...
   <!--<button class="open-button" onclick="openForm()">Open Form</button>-->
		...
		<div class="form-popup" id="myForm">
		  <form action="" class="form-container">
			...
			<button type="button" class="btn" onclick="revise_invoice()">Submit</button>
...
function approve_invoice_req(v)
{
	var id    = document.getElementById("vendor_id").value;
   
	$.ajax({
	type:'GET',
	data:"id="+id+ "&pur_invoice_id=" + v,
    url:"qvision/Purchase_process/delivery_challan/finance_invoice_approve.php",
