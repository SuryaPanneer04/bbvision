	...
	<table class="table table-bordered">
		...
		<table class="table table-bordered" id="new_tab">
			...
			<tr>
				...
				<td colspan="2"><input type="text" class="form-control" id="txt_org_name" value="<?php echo  $row['company_name'];?>" name="txt_org_name" placeholder="Enter Client Name" ></td>
			...
			<td>Location</td>
			<td colspan="4"><input type="text" class="form-control" value="<?php echo $Location;?>" id="Location" name="Location" placeholder="Enter Plant Location" ></td>
			<tr>
				<td>State*</td>
				<td colspan="5">
			...
			<tr>
				...
				<td colspan="4"><input type="text" class="form-control" id="txt_address_1" name="txt_address_1" value="<?php echo $row['address'];?>"placeholder =" Enter The Address"></td>
			</tr>
		<!--	<tr>
				<td></td>
