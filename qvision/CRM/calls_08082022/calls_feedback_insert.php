...
$sql11=$con->query("Update crm_calls_feedback set department='$Department',employee='$employee' where calls_id='$id'"); 
echo "Update crm_calls_feedback set department='$Department',employee='$employee' where calls_id='$id'";
