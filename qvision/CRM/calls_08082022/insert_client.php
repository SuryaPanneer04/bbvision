...
$flag = '2';
 ...
 /*  $sql11=$con->query("insert into enquiry(`Call_type`,`Calls_id`,`Calls_feedbackid`, `date`, `Client_type`, `Company_name`, `Location`,`Address`,`area`,`pincode`,`client_department`,
	...
	values('$Call_type','$enquiry_id','$feedbackid','$date','$Client_type','$Company_name','$Location','$address','$area','$pincode','$client_depart','$client_name','$it_designation','$it_mob1','$it_mob2','$it_mail1','$it_mail2','$it_landno','$client_id','$Product','$list','$feedback','$Follup','$companys','$department_id','$employee_id','$user_id',now())");   */
 ...
 */
	...
	/* echo "insert into new_client_master (department_id,employee_id,org_name,org_type,website,status,flow,created_by,created_on)values('$department_id','$employee_id','$client_org_name','$org_type','$website','$status','$flow','$user_id',NOW())"; */
	...
	$sql11=$con->query("UPDATE `crm_calls` SET `client_id`='$client_id' WHERE id='$enquiry_id'");
