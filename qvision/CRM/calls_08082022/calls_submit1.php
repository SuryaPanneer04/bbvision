...
echo "insert into crm_calls(client_org,client_name,contact,email,website,address,city,state,country,created_by,created_on,status) values('$client_org','$client_name','$contact','$email','$website','$address','$city','$state','$country','$user',now(),1)";
