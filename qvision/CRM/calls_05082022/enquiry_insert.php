...
$sql11=$con->query("insert into crm_calls_feedback(calls_id,feedback,feedback_date,date,remark,created_by,created_on) values('$id','$feedback','$feedback_date','$fed_date','$remark','$user',now())"); 
echo "insert into crm_calls_feedback(calls_id,feedback,feedback_date,date,remark,created_by,created_on) values('$id','$feedback','$feedback_date','$fed_date','$remark','$user',now())";
