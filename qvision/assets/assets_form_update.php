...
$files3 = $_FILES["file3"];
   ...
   $uploadedFile = ''; 
			...
			$upd=$con->query("update assets_form_detail set brand_name='$brand',vendor_name='$vendor',p_date='$pdate',config='$config',warranty='$Warranty',hsn_code='$hsn_code',part_no='$part_no',asset_value='$asset_value',location='$location',invoice_no='$invoice_no',invoice='$fileName',status='1',modified_by='$user_id',modified_on=now(),description='$des',gst_code='$gst_code',Serial_no='$serial' where id='$aid' ");
			
			echo "update assets_form_detail set brand_name='$brand',vendor_name='$vendor',p_date='$pdate',config='$config',warranty='$Warranty',hsn_code='$hsn_code',part_no='$part_no',asset_value='$asset_value',location='$location',invoice_no='$invoice_no',invoice='$fileName',status='1',modified_by='$user_id',modified_on=now(),description='$des',gst_code='$gst_code',Serial_no='$serial' where id='$aid' ";
