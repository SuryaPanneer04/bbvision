...
?>
	...
	<i class="fa fa-table"></i><font style="font-size:18px;"><b> DEDUCTION ADD </b>	</font>
	...
	<option value="0">InActive</option>
	   ...
	   <div class="card-header"> 
	<input type="button" class="btn btn-primary btn-md" onclick="emp_deduction_create()"  style="float:right;" value="SAVE">
...
//alert("nnn");
	 $.ajax({
    type:"POST",
    url:"qvision/deduction/emp_deduction.php",
 ...
 function emp_deduction_create()
{
	...
	type:'GET',
	data: data + "&" + "id="+id,
	  url:"qvision/deduction/emp_deduction_insert.php",
		success:function(data)
		{
			if(data==1)
			{
