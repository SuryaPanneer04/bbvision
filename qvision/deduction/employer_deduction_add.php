...
?>
	...
	<i class="fa fa-table"></i> <font style="font-size:18px;"><b> EMPLOYER DEDUCTION ADD </b></font>
	...
	<div class="col-sm-10">
	<input type="number"  class="form-control" id="max_amount" name="max_amount" placeholder="Maximum Amount">
	</div>
	</div>
	<div class="form-group row">
	...
	<option value="0">InActive</option>
	   ...
	   <div class="card-header"> 
	<input type="button" class="btn btn-primary btn-md" onclick="employer_deduction_create()" value="SAVE" style="float: right;">
...
<script>
 function employer_deduction_create()
{
	 var id=1;
	...
	type:'GET',
	data: data + "&" + "id="+id,
	  url:"qvision/deduction/employer_deduction_insert.php",
		success:function(data)
		{
			if(data==1)
			{
