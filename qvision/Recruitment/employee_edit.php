...
<div  class="card card-primary">
              <div class="card-header">
                <h3 style="float: left;">INTERVIEW FEEDBACK DETAILS EDIT</h3>
				<a onclick="return back_ctc()" style="float: right;" data-toggle="modal" class="btn btn-dark"><i class="fa fa-plus"></i> Back</a>
