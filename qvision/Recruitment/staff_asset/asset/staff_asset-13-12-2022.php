...
<div  class="card card-primary">
   <div class="card-header">
      <h3 class="card-title"><font size="5"> Staff Asset List </font></h3>
 ...
 <div class="card-body">
    ...
    <thead>
     ...
     <th>Action</th>
      ...
      <tbody>
      <?php
      $emp_sql=$con->query("SELECT sm.emp_name,s.stationaries,s.system_or_laptop,s.id_card,s.cug,s.access_card,s.erp_access,s.mail_id,s.id AS sid FROM staff_asset s join staff_master sm on s.emp_name=sm.id");
...
<script>
    ...
    $.ajax({
    type:"POST",
    url:"/KerliERP/Recruitment/staff_asset/new_staff_asset.php",
  ...
  function staff_asset_edit(v)
    ...
    $.ajax({
    type:"POST",
    url:"/KerliERP/Recruitment/staff_asset/edit_staff_asset.php?id="+v,
    success:function(data){
    $("#main_content").html(data);
    }
    })
