...
<div class="container-fluid">
 ...
 <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header" style="margin-top: revert;">Staff Asset List</h1>
                        </div>
                        </div>
 ...
 <td>
  ...
  <?php 
	  ...
	  {
	  ?>
	  <button class="btn btn-success btn-sm edit btn-flat" data-id="<?php echo $emp_res['sid']; ?>" onclick="staff_asset_allocation(<?php echo $emp_res['sid']; ?>)"><i class="fa fa-edit"></i> Allocate</button>
	  </td>
	  <?php 
	  }
	  ?>
...
<script>
    ...
    $.ajax({
    type:"POST",
    url:"/ssinfo1/Recruitment/staff_asset/new_staff_asset.php",
    success:function(data){
    $("#main_content").html(data);
    }
    })
  }
  function staff_asset_allocation(v)
    {
    $.ajax({
    type:"POST",
    url:"/ssinfo1/Recruitment/staff_asset/staff_asset_allocate.php?id="+v,
    success:function(data){
    $("#main_content").html(data);
    }
    })
