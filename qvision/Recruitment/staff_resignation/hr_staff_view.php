...
<div class="card-primary">
  <div class="card-header">
    <h3 class="card-title"><font size="5">Staff Resignation view</font></h3>
...
<tr><td colspan="6"><center><h3>HOD Feedback</h3> </center></td></tr>
      ...
      <tr>
        ...
        <td>Remarks</td>
        <td colspan="5">
            <textarea class="form-control textheight" id="reason" name="reason" readonly> <?php echo $data['hr_rejoin_remark'];?> </textarea>
        </td>
        </tr>
			<?php
		}
