...
<thead>
<tr><th>S.No</th><th>Name</th><th>Percentage</th><th>Amount</th></tr>
</thead>
<tbody>
...
//echo "SELECT id, name, amount, percentage, status, created_by, created_on, modified_by, modified_on FROM payroll_structure where id in (SELECT salary_structure_id FROM payroll_scale_details where payroll_master_id='$earning_id')";
$i=1;
$grand_tot = 0;
