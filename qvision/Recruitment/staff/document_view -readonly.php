...
//echo "select * from staff_master where id='$staid'"; 	
$data1=$staffsel->fetch();
$candidateid=$data1['candid_id'];
$sql=$con->query("select * from candidate_form_details  where id='$candidateid'");
...
<div class="tab-content">
    ...
    <table class="table table-bordered">
        ...
        <td colspan="5"><input type="text" class="form-control" id="candidate_name" name="candidate_name" value="<?php echo $data['first_name'].".". $data['last_name'];?>" readonly></td>
        </tr>
        <tr>
        <td>Father's Name:</td>
        <td colspan="5"><input type="text" class="form-control" id="father_name" name="father_name" value="<?php echo $data['father_name'];?>" readonly ></td>
        </tr>
        <tr>
        <td>Date of Birth:</td>
        ...
        <td colspan="5"><input type="text" class="form-control" id="paddress" name="paddress" value="<?php echo $data['paddress'];?>" readonly></td>
        </tr>
        <tr>
        <td>Telephone no. (Mobile/others):</td>
        <td colspan="5"><input type="text" class="form-control" id="phone" name="phone" value="<?php echo $data['phone'];?>" readonly></td>
        </tr>
        <tr>
        <td>Category (Email ID if any):</td>
        <td colspan="5"><input type="text" class="form-control" id="mail" name="mail" value="<?php echo $data['mail'];?>" readonly></td>
        </tr>
        <tr>
        <td>Aadhar Number:</td>
        <td colspan="4"><input type="text" class="form-control" id="adharnumber" name="adharnumber" value="<?php echo $data['adharnumber'];?>" readonly></td>
        <td colspan="1"><input type="file" class="form-control" id="adharcard" name="adharcard"></td>
        </tr>
        <tr>
        <td>Pan Number:</td>
        <td colspan="4"><input type="text" class="form-control" id="pannumber" name="pannumber" value="<?php echo $data['pannumber'];?>"readonly></td>
        <td colspan="1"><input type="file" class="form-control" id="pancard" name="pancard"></td>
        </tr>
        <tr>
        <td>Voter ID:</td>
        <td colspan="4"><input type="text" class="form-control" id="voternumber" name="voternumber" value="<?php echo $data['voternumber'];?>" readonly></td>
