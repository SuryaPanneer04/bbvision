...
$cur1 = date('Y-m-d', strtotime('-1 day', strtotime($cur)))	;													echo $cur1; ?>">
  ...
  border-left: white;height: 41px;
    width: 246px;" type="text" id="remark6" name="remark6"></th>
      ...
      $.ajax({
            type: "POST",
            url: "Recruitment/project_management/daily_mis/attire_form/house/submit.php?date="+to_date,
...
//alert(data);
    ...
    type:'GET',
    data: data + "&" + "id="+id,
    url:"Recruitment/project_management/daily_mis/attire_form/house/house_submit.php",	
    success:function(data)
    {      
...
//alert(department_id);
            $.ajax({
                url: "Recruitment/project_management/daily_mis/attire_form/attire/get_designation.php",
...
//alert(department_id);
            $.ajax({
                url: "Recruitment/project_management/daily_mis/attire_form/attire/find_emp.php",
                type: "GET",
                data: {
                    department_id: department_id
