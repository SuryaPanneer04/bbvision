...
//echo "SELECT a.id as emp_id,a.*,b.* from time_sheet a left join staff_master b on(a.staff_id=b.candid_id)";
	...
	<td>	
		...
		<button class="btn btn-primary btn-sm view btn-flat" data-id="<?php echo $emp_res['emp_id']; ?>" onclick="report_view(<?php echo $emp_res['emp_id']; ?>)"><i class="fa fa-view"></i> View</button>
