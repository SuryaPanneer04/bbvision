...
<form enctype="multipart/form-data" name="fupForm" id="fupForm" name="add_name" method="POST" role="form">
	...
	<div class="has-feedback" style="left: 15px;position: relative;">
		<a href='qvision/Recruitment/sim_master/sim_master.csv' target="_blank" style="color:blue;">Sim Master Template</a>
	</div><br>
...
<script>
		...
		$("form[name='fupForm']").on("submit", function(ev) {
		 ...
		 var formData = new FormData(this);	  
           $.ajax({  
                url: 'qvision/Recruitment/sim_master/insert_sim_excel.php',
                method:"POST",  
                data:formData, 
				cache: false,
				contentType: false,
