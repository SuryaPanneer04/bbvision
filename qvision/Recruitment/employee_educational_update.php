...
$uploadDir = 'qvision/Recruitment/uploads/'; 
...
$today = date("Y-m-d H:i:s"); 
 ...
 $upd=$con->query("update emp_qualification set attachment='$fileNames[$i]',modified_by='$candidateid',modified_on=now() where emp_id='$candidateid' and education='$examination' ");
