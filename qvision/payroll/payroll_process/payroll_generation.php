...
.generated{
	...
	if($flag==2) 
	{
		...
		//	echo $result['month'].'kjhgf';
			//print_r($result);
			?>
			<thead>
			<tr>
			<th><span class="generated"> Payroll Generated </span></th>
			<th>Month</th>
...
<th>
	...
	function Gen_staff_salary()
	{
		var month=$('#month').val();
		var year=$('#year').val();
		$("#salary_view").html('<br><div style="text-align: center;"><img src="images/loader/loader.gif"></div>');
