...
// CLEAR OLD CALCULATIONS ON RE-RUN TO AVOID DUPLICATE SALARY BUGS:
$con->query("DELETE FROM payroll_salary_earnings WHERE payroll_month='$month' AND payroll_year='$year'");
$con->query("DELETE FROM payroll_salary_deduction WHERE payroll_month='$month' AND payroll_year='$year'");
$con->query("DELETE FROM payroll_final_salary WHERE payroll_month='$month' AND payroll_year='$year'");
...
/////////////////////////////////////// SALARY ADVANCE //////////////////////////////////////////////////
			...
			if ($lop > 0) {
				...
				// Prepare the data for insertion (FIXED: Exactly 12 values to match 12 columns)
				$data = array($date, $month, $year, $emp_code, $emp_name, 'Loss Of Pay', $totalDaysOflop, $daysss, $days_worked, 1, 1, $date);
