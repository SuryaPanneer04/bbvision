...
// $month1 = $month;
// $year1 = $year;
//echo $month."[2222222]".$year;

						
    switch ($month) {
      case "1":
       $pay_period = "16th Jan".' '.$year." – 15th Feb".' '.$year;
      break;
	  
      case "2":
       $pay_period = "15th Feb".' '.$year." – 16th Mar".' '.$year;
      break;
	  
      case "3":
       $pay_period = "16th Mar".' '.$year." – 15th Apr".' '.$year;
      break;
	  
	  case "4":
       $pay_period = "16th Apr".' '.$year." – 15th May".' '.$year;
      break;
	  
	  case "5":
       $pay_period = "16th May".' '.$year." – 15th Jun".' '.$year;
      break;
	  
	  case "6":
       $pay_period = "16th Jun".' '.$year."- 15th Jul".' '.$year;
      break;
	  
	  case "7":
       $pay_period = "16th Jul".' '.$year." – 15th Aug".' '.$year;
      break;
	  
	  case "8":
       $pay_period = "16th Aug".' '.$year." – 15th Sep".' '.$year;
      break;
	  
	  case "9":
       $pay_period = "16th Sep".' '.$year." – 15th Oct".' '.$year;
      break;
	  
	  case "10":
       $pay_period = "16th Oct".' '.$year." – 15th Nov".' '.$year;
      break;
	  
	  case "11":
       $pay_period = "16th Nov".' '.$year." – 15th Dec".' '.$year;
      break;
	  
	  case "12":
       $pay_period = "16th Dec".' '.$year." – 15th Jan".' '.$year;
      break;
	  
     default:
	   $m1 = $month;
       $mon = date('Y-' . $m1 . '-d');
       $pay_period = date('F', strtotime($mon)) . " - " . $year;
    }
?>
<head>
    <!-- Font Awesome -->
    ...
    <div class="card-body">
        ...
        <table class="table table-striped" id="branchwisecollection2">
            <form method="post" action="" >
			   ...
			   if ($flag == 2) {
                    $sql = "select COUNT(*),id from payroll_master where month='$month' and year='$year' and flag='2'";
                   // echo $sql;exit();
                    $res = $con->query($sql);
                    ...
                    if ($count <> 0) {
                        ...
                        $sth = $con->query("SELECT id, month, year, date, flag FROM payroll_master where month='$month' and year='$year' and flag='2'");
                      ...
                      //  print_r($result);
                        ...
                        <thead>
                            <tr>
                                <th>Payroll Period Month</th>
                        <input type="hidden" name="month1" id="month1"  value="<?php echo $month ?>">
                        ...
                        <th>
                            ...
                            // $m2 = $month1;
                            // $mon1 = date('Y-' . $m2 . '-d');
                            // date('F', strtotime($mon1)) . " - " . $year1;
							echo $pay_period;
                            ?>
                        </th>
                        <th style="color:green;"> <label for='payrollGenerated'>Payroll Generated </label> </th>
                        <th><input type="button" name="delete_payroll" id="delete_payroll" onclick="payroll_delete()" value="Delete"/></th> 
                        <?php
                    } else {
                        ?>
                        <center><h2>You Don't Have Salary Approve Provision</h2></center>
                        <?PHP
                    }
                }
                ?>
        ...
        <script>
            ...
            function payroll_delete()
            {
                ...
                $.ajax({
                    type: "GET",
                    url: "qvision/payroll/payroll_process/payroll_approve.php",
