...
//"select * from quote_generate where id='$quoteid'"
...
<div  class="card card-primary">
    ...
    <table class="table table-bordered">
		...
		<!--<tr>
		  <td colspan="8" align="center"><b>GST Persentage <?php echo $cfet['gst_per']; ?>%</b></td>
		...
		<tr>
		  <td colspan="8" align="center"><b>IGST Persentage <?php echo $cfet['igst_per']; ?>%</b></td>
		  <td colspan="8" align="right">
	 ...
	 $serstatus=$fet['md_status'];
	 if($fstatus=='0' and $serstatus=='1' and $marstatus=='1' )
	 {
		 ?>
		 <tr>  
...
function approve_po(v)
{
	...
	$.ajax({
		...
		url:"qvision/BusinessProcess/po_approval/po_submit.php?id="+v+'&cost_sheet_no='+cost_sheet_no+'&enquiry_id='+enquiry_id,
		success:function(data)
		{
...
function marketing_po_mail()
    {
        ...
        $.ajax({
            ...
            url: "qvision/BusinessProcess/po_approval/finanace_po_mail.php?costsheet_no="+cost_sheet_no1,
            success: function (data) {
