...
$sel=$con->query("update po_generate set md_status='1',md_approved_by='$candidateid',po_upload_status='1' where id='$qid'");
...
$update_query = $con->query("update cost_sheet_entry set status ='8' WHERE cost_sheet_no= '$cost_sheet_no'");  
...
$mail->AddAddress('karthick@ssinformation.in', 'Karthick');		//Adds a "To" addresss
//$mail->addAddress("laxmipriya@bluebase.in");     // Add a recipient
$mail->WordWrap = 50;                                 // Set word wrap to 50 characters
$mail->isHTML(true);                                 // Set email format to HTML
$subject="PO Approved by Marketing Head.";			
	$html_table = 'Dear&nbsp;&nbsp; Karthick,  <br> 
		&nbsp;&nbsp;	This Mail regarding Marketing Level 2 PO approved and waiting for Finance Approve.';
