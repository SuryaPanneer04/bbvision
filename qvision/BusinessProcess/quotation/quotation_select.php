...
$quote=$con->query("select q.*,c.cost_sheet_no,c.enquiry_id from quote_generate q left join cost_sheet_entry c ON q.cost_sheet_no=c.cost_sheet_no where q.id='$cs'");
...
<!--<div id="regularform">--->
	  ...
	  <?php } */ ?>
                    ...
                    <table id="dataTable" width="350px" border="1" style="border-collapse:collapse;border: 1px solid !important;margin-left: 1px;" class="table border m_b_0px">
				 ...
				 where a.status ='3' and a.cost_sheet_no='$cost_sheet_no' order by a.id desc");
                    ...
                    <div style="font-size:15px;min-width:708px;min-height:500px;border-top: 1px solid black;border-left: 1px solid black; border-right: 1px solid black;border-bottom: 1px solid black;">
                        ...
                        <div style="width: 100%;border-top: 1px solid black;border-bottom: 1px solid black;height:100px;">
                            <div style="width: 60%; height: 100px; float: left;border-right: 1px solid black;">
