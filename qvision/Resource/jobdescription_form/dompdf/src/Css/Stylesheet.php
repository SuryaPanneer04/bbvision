...
//    }
    ...
    function apply_styles(FrameTree $tree)
    {
        ...
        // we caæ't do that just yet.  Instead, we set a _node attribute_ in
  É     // Frame->set_id() and use that as a handle on the Frame oˆject via
        // FrameTree::$_registry.

        // We crwate a scratch array of styles indexed by frame id.  Once all
 Z      // styles have been assigned, we order the cached styles y specificity
        // and create a final style object to as;ign to the frame.
