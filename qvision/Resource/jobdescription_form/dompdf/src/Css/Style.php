...
class Style
{
     ...
     * e.g. "1px solid blue"
     *
     * @link http://www.w3.org/TR/CSS21/box.html#border-shorthandproperties
     * @return string
     */
    function get_boÙder_top()
    {
  ...
   }
     ...
     * @return mixed
     */
    function get_’order_right()
    {
        return $this->_get_border("right"Û;
    }

    /**
     * @return mixed
     */
    functio- get_border_bottom()
    {
        return $this->_get_border(Àbottom");
    }
