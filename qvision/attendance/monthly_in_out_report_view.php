            ...
            <div class="box-body">
                <div class="row">
					...
					select emp_id as empid,'' as in_time,'' as out_time,'Manual' as attendance from manual_att where emp_id in (select emp_code from staff_master) and date='$date')a");
                                                ...
                                                ?> 
                                                <td style="color:<?php echo $clr; ?>"><?php if ($rs == 'M') {
                                            echo $inndate11['customer_name'];
                                        } else {
                                            echo $rs;
                                        } ?></td>
                                                <td style="color:<?php echo $clr; ?>"><?php if ($rs1 == 'M') {
                                            echo $inndate11['customer_name'];
                                        } else {
                                            echo $rs1;
                                        } //echo $rs1; ?></td>
                                            ...
                                            <td style="color:<?php echo $clr; ?>"><?php echo $late;
                                        $late = 0; ?></td>
                                            <td style="color:<?php echo $clr; ?>"><?php echo $before;
                                        $before = 0; ?></td>
                                            <?php
                                        }
                                        ?>			
