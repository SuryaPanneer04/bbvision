	...
	<div class="card">
			...
			<td>
				<input type="button" name="daily_report_view" id="daily_report_view" class="btn btn-success" value="SEARCH" onClick="monthly_report()"></td>
			</tr>
			</tbody>
			</table>
			</form>
	...
	<div class="col-12" id="attendance_monthly_report_view">	
	</div>
<script>
